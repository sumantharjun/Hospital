...
export default function PatientSearchPage() {
  ...
  function printPatientReport() {
    ...
    <tbody>${data.results.map((r: any) => `<tr>
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-[#4a5568] mt-0.5">Search across IP admissions, OP visits, and services by name, phone, or record ID</p>
          </div>
          {data && (
          ...
          <>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
              {[
                ...
                { label: "Outstanding",  value: fmtCur(data.summary.totalOutstanding),   style: data.summary.totalOutstanding > 0 ? "bg-red-50 text-red-700" : "bg-gray-50 text-gray-500" },
              ].map((s) => (
                            ...
                            <div>
                              ...
                              <div className="bg-white border border-[#e2e8f0] rounded-sm overflow-hidden">
                                <table className="w-full text-xs">
                                  ...
                                  <tbody>
                                    {r.bill.lineItems.map((li: any, j: number) => (
                          ...
                          {r.bill?.paymentHistory?.length > 0 && (
                            <div>
                              ...
                              <div className="space-y-1">
                                {r.bill.paymentHistory.map((p: any, j: number) => (
