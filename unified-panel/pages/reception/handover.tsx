...
import { RefreshIcon, CheckIcon, PrintIcon, ReportsIcon, AlertIcon, BillingIcon, IPAdmissionIcon, OPRegistrationIcon } from "@/components/Icons";
...
export default function HandoverPage() {
  ...
  const fetchData = useCallback(async (silent = false) => {
    ...
    const todayApts = aptsArr.filter((a: any) => {
  ...
  function printHandover() {
    ...
    ${data.pendingBills.slice(0, 20).map((b: any) => `<tr>
              ...
              {data.pendingBills.length === 0 ? (
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-xs">
                    ...
                    <tbody>
                      {data.pendingBills.slice(0, 10).map((b: any) => (
        ...
        <div className="gov-card overflow-hidden">
          ...
          <div className="p-4">
            <textarea
              ...
              rows={5}
              placeholder="Write handover notes for the incoming receptionist..."
